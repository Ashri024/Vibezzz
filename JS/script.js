...
form_onokay.addEventListener("click",()=>{
    ...
    let guide__sub_section=Array.from(document.getElementsByClassName("guide_sub_section"));
    let guide__sub_section_down=Array.from(document.getElementsByClassName("guide_sub_section_down"));
    let guide__sub_section_song=Array.from(document.getElementsByClassName("guide_sub_section_song"));
    console.log(guide_p);
